    ...
    >
      <section className="bg-[#fff9f0] min-h-[80vh] flex flex-col items-center justify-center px-6 py-20">
        <div className="max-w-3xl w-full mx-auto text-center">
          ...
          {/* Eyebrow pill */}
          <div className="inline-flex items-center gap-1.5 border border-[#f08c21]/40 rounded-full px-4 py-1.5 mb-8">
            <span className="text-[#f08c21] text-xs">✦</span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
            <button
              ...
              className="bg-[#f08c21] text-white font-nunito font-semibold rounded-full px-7 py-3 hover:bg-[#e07010] transition-colors"
            >
              Join the waitlist
            </button>
            <button
