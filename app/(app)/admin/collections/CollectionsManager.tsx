  ...
  if (view === 'list') {
    return (
      <div>
        <button
          onClick={startCreate}
          className="w-full mb-4 h-11 rounded-2xl bg-[#f89a14] text-white font-syne font-bold text-[15px]"
        >
          + New Collection
        </button>
    ...
    <div>
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex-[2] h-11 rounded-2xl bg-[#f89a14] text-white font-syne font-bold text-[14px] disabled:opacity-50"
        >
