  ...
  return (
    <main className="min-h-screen bg-[#fff9f0] px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="font-brice text-3xl font-bold text-[#131936]">Analytics</h1>
...
function StatCard({ label, value, sub }: { label: string; value: string; sub: string }) {
  return (
    <div className="rounded-2xl border border-[#fcd99a]/40 bg-white px-5 py-5">
      ...
      <p className="font-brice text-4xl font-bold text-[#f08c21]">{value}</p>
...
function Section({ title, children }: { title: string; children: ReactNode }) {
  return (
    <section className="mb-8">
      <h2 className="font-brice text-lg font-bold text-[#131936] mb-4">{title}</h2>
      {children}
    </section>
  )
}
