        ...
        <div className="mb-6">
          ...
          {tripItems.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-[#fcd99a]/50 p-8 text-center">
              ...
              <button
                onClick={() => setShowAdd(true)}
                className="rounded-xl bg-[#f89a14] hover:bg-[#f89a14]/90 px-4 py-2 text-sm font-syne font-semibold text-[#131936] transition-colors"
              >
    ...
    return (
      <div className="rounded-2xl border border-[#fcd99a]/40 bg-white p-8 text-center mb-6">
        ...
        <button
          ...
          className="rounded-xl bg-[#f89a14] hover:bg-[#f89a14]/90 disabled:opacity-50 px-5 py-2.5 font-syne font-semibold text-[#131936] text-sm transition-colors"
        >
