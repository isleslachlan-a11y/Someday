  ...
  if (!MAPBOX_TOKEN) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-120px)] lg:h-[calc(100vh-56px)] gap-4 px-6 text-center">
        ...
        <h2 className="font-brice text-lg font-bold text-white-soft">Map not configured</h2>
    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center justify-between gap-3 px-4 h-14 bg-[#130f2a]/80 backdrop-blur-sm border-b border-white/[0.07] shrink-0">
        <div className="min-w-0">
          <h1 className="font-brice text-lg font-bold text-white-soft leading-none">Explore</h1>
          {cityPlaces.length > 0 && (
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-start gap-3 px-5 pt-4 pb-3 shrink-0">
        <div className="flex-1 min-w-0">
          ...
          <h3 className="font-brice text-xl font-bold text-white-soft leading-tight">
            {place.name}
          </h3>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6">
        ...
        <button
          ...
          disabled={isAdded}
          className={`w-full rounded-xl py-3 font-brice font-semibold text-sm transition-all active:scale-[0.98] ${
            isAdded
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-5 pt-5 pb-3 shrink-0">
        <h2 className="font-brice font-bold text-white-soft text-base">Choose city</h2>
        <button
          onClick={onClose}
