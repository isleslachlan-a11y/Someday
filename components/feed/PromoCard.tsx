  ...
  return (
    ...
    >
      ...
      <div className="relative h-[220px] bg-gradient-to-br from-[#1a1035] via-[#130f2a] to-[#0d0b1a] overflow-hidden flex items-center justify-center">
        ...
        <span
          className="absolute font-syne font-black text-white select-none pointer-events-none text-center px-8 leading-tight"
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-4">
          <h3 className="font-syne text-[20px] font-bold text-white leading-tight">
            {promo.title}
          </h3>
        </div>
      </div>
